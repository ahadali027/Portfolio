  ...
  useEffect(() => {
    ...
    class Particle {
      constructor() {
        ...
        this.color = `rgba(${Math.random() * 80 + 100}, ${Math.random() * 80 + 100}, ${Math.random() * 120 + 135}, ${Math.random() * 0.3 + 0.2})`;
      }
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (distance < connectionDistance) {
            ctx.beginPath();
            ctx.strokeStyle = `rgba(100, 120, 255, ${0.2 * (1 - distance / connectionDistance)})`;
            ctx.lineWidth = 0.5;
  ...
  return (
    <section className="relative min-h-[calc(100vh-0px)] md:min-h-screen flex items-center py-12 md:py-16 lg:py-20 overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          transform: `rotate(${12 + mousePosition.x * 0.01}deg) translateX(${mousePosition.x * 0.01}px)`,
      ...
      <div 
        ...
        style={{ 
          transform: `rotate(${45 + mousePosition.y * 0.01}deg) translateY(${mousePosition.y * 0.01}px)`,
          transition: 'transform 0.2s ease-out'
        }}
      ></div>
      <div 
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          >
            ...
            >
              Crafting <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-500 dark:from-primary-400 dark:to-secondary-400">digital</span> experiences that <span className="relative">
                elevate
                <svg className="absolute -bottom-1 md:-bottom-2 left-0 w-full" viewBox="0 0 100 10" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0,3 Q25,10 50,3 Q75,-4 100,3" stroke="url(#gradient-underline)" strokeWidth="2" fill="none" />
                  <defs>
            ...
            >
              Building modern, responsive, and intuitive web applications that solve real-world problems and deliver exceptional user experiences.
            </motion.p>
          ...
          >
            <div className="relative mx-auto max-w-[280px] sm:max-w-[340px] md:max-w-[380px] lg:max-w-md">
              ...
              >
                ...
                <div className="absolute inset-0 backdrop-blur-sm bg-white/50 dark:bg-dark-800/50 rounded-full border border-white/30 dark:border-white/10 shadow-2xl flex items-center justify-center overflow-hidden">
                  ...
                  <div className="relative w-4/5 h-4/5 grid grid-cols-2 gap-3 md:gap-4">
                    ...
                    >
                      ...
                      <span className="mt-1 md:mt-2 text-xs md:text-sm font-medium text-gray-800 dark:text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity">MongoDB</span>
                    </motion.div>
                    <motion.div 
                      className="bg-white/70 dark:bg-dark-200/70 backdrop-blur-md rounded-xl md:rounded-2xl shadow-lg flex flex-col items-center justify-center group"
                      whileHover={{ scale: 1.05, rotateZ: -5 }}
                    ...
                    >
                      ...
                      <span className="mt-1 md:mt-2 text-xs md:text-sm font-medium text-gray-800 dark:text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity">Express</span>
                    </motion.div>
                    <motion.div 
                      className="bg-white/70 dark:bg-dark-200/70 backdrop-blur-md rounded-xl md:rounded-2xl shadow-lg flex flex-col items-center justify-center group"
                      whileHover={{ scale: 1.05, rotateZ: -5 }}
                    ...
                    >
                      ...
                      <span className="mt-1 md:mt-2 text-xs md:text-sm font-medium text-gray-800 dark:text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity">React</span>
                    </motion.div>
                    <motion.div 
                      className="bg-white/70 dark:bg-dark-200/70 backdrop-blur-md rounded-xl md:rounded-2xl shadow-lg flex flex-col items-center justify-center group"
                      whileHover={{ scale: 1.05, rotateZ: 5 }}
                    ...
                    >
                      ...
                      <span className="mt-1 md:mt-2 text-xs md:text-sm font-medium text-gray-800 dark:text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity">Node.js</span>
                    </motion.div>
                  </div>
                </div>
                ...
                >
                  <span className="text-primary-600 dark:text-primary-400">Responsive</span>
                </motion.div>
                ...
                >
                  <span className="text-secondary-600 dark:text-secondary-400">Interactive</span>
                </motion.div>
              </motion.div>
            </div>
          </motion.div>
